...
|--------------------------------------------------------------------------
|
| Configure webhook integration with n8n for ticket automation
|
*/
$config['n8n_webhook_enabled'] = TRUE;  // Set to TRUE to enable webhooks
$config['n8n_webhook_url'] = 'https://n8n.kmkentertainment.com/webhook/56e660da-7333-4d2c-a755-7673bf52077a';  // Your n8n webhook URL (e.g., https://n8n.yourdomain.com/webhook/tickets)
$config['n8n_webhook_debug'] = TRUE;  // Enable debug logging
